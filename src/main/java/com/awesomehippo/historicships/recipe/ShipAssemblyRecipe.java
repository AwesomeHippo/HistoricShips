...
public final class ShipAssemblyRecipe {
    ...
    private static final List<ShipAssemblyRecipe> RECIPES = List.of(
            new ShipAssemblyRecipe(Component.translatable("gui.historicships.recipe.drakkar"), () -> new ItemStack(NapoleonShipMod.DRAKKAR_ITEM.get()), List.of(tag(ItemTags.LOGS, 48), item(Items.STICK, 48), item(Items.WHITE_WOOL, 16), item(Items.STRING, 4), item(Items.LEATHER, 4)), ShipsConfig.DRAKKAR),
            new ShipAssemblyRecipe(Component.translatable("gui.historicships.recipe.quinquereme"), () -> new ItemStack(NapoleonShipMod.QUINQUEREME_ITEM.get()), List.of(tag(ItemTags.LOGS, 64), item(Items.STICK, 16), item(Items.WHITE_WOOL, 24), item(Items.COPPER_INGOT, 12), item(Items.IRON_INGOT, 4), item(Items.STRING, 8), item(Items.GOLD_INGOT, 12)), ShipsConfig.QUINQUEREME),
